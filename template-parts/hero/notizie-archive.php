...
$testo_notizie = av_get_option("testo_notizie", "notizie");
            ...
            <div class="row variable-gutters">
                <div class="col-md-5">
                    <div class="hero-title text-left">
                        <?php the_archive_title( '<h1 class="font-titoli p-0 mb-2">', '</h1>' ); ?>
                        <?php
                        remove_filter('get_the_post_type_description', 'wpautop');
                        the_archive_description("<h2 class=\"h4 font-corpo font-weight-normal\">","</h2>");
