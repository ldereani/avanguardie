...
$img_identita = av_get_option("immagine", "la_scuola");
//$id_scuola_principale = av_get_option("scuola_principale", "homepage");
$landing_url = av_get_template_page_url("page-templates/la-scuola.php");
...
<section class="section bg-redbrown section-hero-left">
        ...
        <div class="row variable-gutters">
            <div class="col-md-<?php echo $colid; ?>">
                <div class="hero-title">
                    <h1><span class="font-titoli colore-secondario d-line d-xl-block"><?php echo "ARTE MATERICA<br/>E SOSTENIBILE" ?></span> </h1>
                    <div class="font-corpo colore-primario font-weight-normal h4"><?php echo "Unione di Artisti contro la<br/>Crisi Climatica"; ?> </div>
                    <h2 class="colore-primario font-weight-normal h3"><?php echo av_get_option("luogo_scuola"); ?></h2>
                    <?php if($landing_url){ ?>
                        <a class="btn btn-sm btn-outline-white mt-4" href="<?php echo $landing_url; ?>" aria-label="Vai alla scuola"><?php _e("Vai alla scuola", "avanguardie"); ?></a>
                    <?php } ?>
    ...
    <?php $img_identita = get_stylesheet_directory_uri(). "/assets/images/bosa.jpg"; ?>
