...
if(count($argomenti)) {
	...
	// recupero articoli, eventi e collegati agli argomenti del post
		...
		<div class="container pt-3">
			...
			<div class="row variable-gutters">
				<div class="col-lg-12">
					...
					<h3 class="mb-5 text-center semi-bold text-gray-primary"><?php _e("Schede didattiche correlate", "curricoli"); ?></h3>
