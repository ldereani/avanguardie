		...
		<div class="container">
			...
			<div class="row variable-gutters">
				<div class="col-lg-12">
					...
					<h3 class="mb-4 text-center semi-bold text-gray-primary"><?php _e( "Altri contenuti che potrebbero interessarti", "curricoli" ); ?></h3>

					<div class="badges-wrapper text-center mt-0 mb-4">
						<small><strong><?php _e( "Contenuti filtrati per:", "curricoli" ); ?></strong>
						</small>
						<div class="badges mt-3">
							<?php
							foreach ( $argomenti as $item ) { ?>
								<a href="<?php echo get_term_link( $item ); ?>"
								   title="<?php _e( "Vai all'argomento", "curricoli" ); ?>: <?php echo $item->name; ?>"
									...
									<div class="card card-bg h-100 rounded">
										<div class="card-body">
											<div class="card-header accordion-header">
												...
												<span><?php _e( "Servizi", "curricoli" ); ?></span>
									...
									<div class="card card-bg h-100 rounded">
										<div class="card-body">
											<div class="card-header accordion-header">
												...
												<span><?php _e( "Notizie", "curricoli" ); ?></span>
											</div><!-- /accordion-header -->
											<div class="card-content accordion-content">
												<ul>
													<?php
									...
									<div class="card card-bg h-100 rounded">
										<div class="card-body">
											<div class="card-header accordion-header">
												...
												<span><?php _e( "Documenti", "curricoli" ); ?></span>
											</div><!-- /accordion-header -->
											<div class="card-content accordion-content">
												<ul>
													<?php
