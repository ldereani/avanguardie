...
$oldpost = $post;
$argomenti = cdv_get_classi_of_post();
if(count($argomenti)) {
	// estraggo gli id
	$arr_ids = array();
	...
	// recupero articoli, eventi collegati agli argomenti del post
		...
		<div class="container pt-3">
			...
			<div class="row variable-gutters">
				<div class="col-lg-12">
					...
					<h3 class="mb-5 text-center semi-bold text-gray-primary"><?php _e("Altri percorsi della stessa disciplina", "curricoli"); ?></h3>
