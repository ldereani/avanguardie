						...
						<div class="row variable-gutters">
							<div class="col">
								...
								<div class="form-group search-form">
									...
									<input type="text" name="s" id="search-input" data-element="search-modal-input" class="form-control" placeholder="<?php _e("Cerca informazioni, eventi, notizie o documenti","design_scuole_italia"); ?>" value="<?php echo get_search_query(); ?>">
								...
								<div class="cat-filters">
                                    ...
                                    $post_types = av_get_post_types_grouped("news");
                                    if(av_count_grouped_posts($post_types)) {
                                    ?>
                            ...
                            <div class="col-lg-5">
                                ...
                                <ul class="searches-list">
                                    ...
                                    if (is_array($popular_posts->posts)) {
                                        ...
                                        $group = av_get_post_types_group($post->post_type);
                                    ?>
                                        <li>
                                            <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                            <!-- <span><?php #echo av_get_italian_name_group($group) ?></span> -->
                                        </li>
                                    <?php
                                    }} else { ?>
