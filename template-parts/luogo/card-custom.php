...
$posizione_gps =  av_get_meta("posizione_gps_luogo_custom");
$indirizzo_luogo_custom = av_get_meta("indirizzo_luogo_custom");
$arrq = array();
if(av_get_meta("quartiere_luogo_custom") != "")
	$arrq[]=av_get_meta("quartiere_luogo_custom");
if(av_get_meta("circoscrizione_luogo_custom") != "")
	$arrq[]=av_get_meta("circoscrizione_luogo_custom");
?>
