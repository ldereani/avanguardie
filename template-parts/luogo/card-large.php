...
if($luogo->post_parent == 0){
	...
	$indirizzo = av_get_meta("indirizzo", "_av_luogo_", $luogo->post_parent);
	$posizione_gps = av_get_meta("posizione_gps", "_av_luogo_", $luogo->post_parent);
	$cap = av_get_meta("cap", "_av_luogo_", $luogo->post_parent);
	$mail = av_get_meta("mail", "_av_luogo_", $luogo->post_parent);
	$telefono = av_get_meta("telefono", "_av_luogo_", $luogo->post_parent);
}
