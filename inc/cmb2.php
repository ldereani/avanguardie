...
function av_get_user_options( $query_args = false) {
...
function av_get_gruppi_options( $query_args = false) {
...
function av_get_program_options( $query_args = false) {
...
function av_get_luoghi_options( $parent = false, $addnone=false) {
	if($parent)
...
function av_get_strutture_options( ) {
...
function av_get_strutture_scuole_options( ) {
 ...
 * @return array
 */
function av_get_servizi_options( ) {
 ...
 * @return array
 */
function av_get_servizi_didattici_options( ) {
...
function av_get_tipologie_strutture_options( ) {
...
function av_get_tipologie_luoghi_options( ) {
...
function av_get_tipologie_documenti_options( ) {
...
function av_get_strutture_indirizzo_scuole_options( ) {
    ...
    if ( $strutture ) {
        foreach ( $strutture as $struttura ) {
            // per ogni scuola seleziono i percorsi abilitati
               $percorsi = av_get_meta("percorsi", "", $struttura->ID);
        //    print_r($percorsi);
 ...
 */
function av_get_approfondimenti_options( ) {
...
/*
 ...
 // todo: programma materia
function av_get_classe_options( $query_args = false) {
...
*/
function av_get_tipologie_amministrazione_trasparente( $query_args = false) {
 ...
 * @return array
 */
function av_get_tipologia_servizi_options( $query_args = false) {
 ...
 * @return array
 */
function av_get_tipologia_articoli_options( $query_args = false) {
