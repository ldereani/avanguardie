...
add_action("template_redirect", "cdv_pdf_generator");

function cdv_pdf_generator(){
    global $post;
...
?>
        ...
        <p class="h1">
            <span><?php echo cdv_get_option("tipologia_rete"); ?></span>
            <br>
            <span><strong><?php echo cdv_get_option("nome_scuola"); ?></strong></span>
            <br>
            <span class="d-none d-lg-block"><?php echo cdv_get_option("luogo_scuola"); ?></span>
        ...
        <footer style="text-align: center">
            ...
            echo cdv_get_option("nome_scuola");
            echo "<br>";
